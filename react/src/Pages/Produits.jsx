...
const Produits = () => {
  return (
    <div class="mt-5" >
        <p class="px-5 ">
            <Link to="/" class="text-slate-300">Products<span> &gt; </span>  </Link>
            
            <Link to="/" class="text-slate-300">  List  </Link>
        </p>
       <div class="grid grid-cols-6 gap-4 px-5">
          ...
          <div class="md:columns-3 sm:columns-1 px-3 mt-3">
                <div class="bg-white  border-gray-400 rounded-md m-2 ">
                    <div class="haut">
                        <p class="text-gray-500">Produits totaux <br/>
                        <span class="font-medium mt-1 text-4xl">52</span>
                        </p>
                    </div>
                </div>
                
                <div class=" bg-white px-5 py-5 border-gray-400 rounded-md m-2">
                    <p class="text-gray-500">Inventaire de produits <br/>
                      <span class="font-medium mt-1 text-4xl">278</span>
                    </p>
                </div>
                <div class=" bg-white px-5 py-5 border-gray-400 rounded-md m-2">
                    <p class="text-gray-500">Prix ​​moyen<br/>
        ...
        <div class="relative border-b-1 w-100">
            ...
            type="text"
            id="search"
            class="block p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80  focus:ring-amber-500 focus:border-amber-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-amber-500 dark:focus:border-amber-500"
            placeholder="Search"
            />
          </div>
        ...
        >
          ...
          <div class="flex focus:ring-amber-500 dark:focus:ring-amber-600">
           <p className='mt-2'>Per Page </p>
            <select name="" id="" vlaue="Per Page" class="rounded-sm ml-2 border-opacity-0 focus:ring-amber-500 dark:focus:ring-amber-600">
